...
$sql =("SELECT email from medecins WHERE email ='".$mail."' limit 1");
 $query=mysqli_query($con,$sql);
 $sqlmdp="SELECT password from medecins WHERE email='".$mail."' limit 1";
...
<html>
	<body>
		<div align="center">
			...
			<a href="http://localhost/park%20shine%20soo%20-%20Copie/home.php">connexion ici</a>
...
<section class="login-block">
  ...
  <div class="form-group"><br><br><br><br>
    ...
    <div class="carousel-item active">
      <img class="d-block img-fluid" src="a.jpg" alt="First slide">
