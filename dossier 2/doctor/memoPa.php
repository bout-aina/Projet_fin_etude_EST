...
if (isset($_POST["valider"])){
	...
	$d=	date("Y-m-d H:i:s",strtotime('-1 day'));
$date=date("Y-m-d H:i:s",strtotime($d.'+22 hours'));
	$msg=$_POST['msg']; 
	$sql = "insert into messages (message,created_at) values ('$msg','$date')";
    $dbh->exec($sql);	echo(" 
...
if (isset($_POST["quiter"])){
	 ...
	 header("location:http://localhost/doctor/doctorMemo1.php");
...
<!------ Include the above in your HEAD tag ---------->
  ...
  <div class="login-wrap">
	<div class="login-html">
		<input id="tab-1" type="radio" name="tab" class="sign-in" checked><label for="tab-1" class="tab">            Memo</label>
		...
		<div class="login-form">
            ...
            <form  method="POST" >
				<div class="group">
					<label for="user" class="label">ce message est distiné au patient </label>
                    <textarea id="user" type="text" name='msg'  class="input" >
</textarea>
				</div>
