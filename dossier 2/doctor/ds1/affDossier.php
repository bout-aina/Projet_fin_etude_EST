...
foreach ($res as $data) {$x++;

	echo '
                  <div class="top-droppable folder tooltiper tooltiper-up" data-tooltip="0 file" id="folder'.$x.'"><a href="#"><i class="fa fa-folder" aria-hidden="true"></i><i class="fa fa-check" aria-hidden="true"></i><p>'.$data['cin'].'</p><a></div>
