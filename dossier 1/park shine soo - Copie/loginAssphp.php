...
$sql =("SELECT emailAss from cnxassistant WHERE emailAss ='".$mail."' limit 1");
...
<html>
	<body>
		<div align="center">
			...
			<a href=http://localhost/park%20shine%20soo%20-%20Copie/loginAssphp.php>mon nouveau mot de passe</a>
