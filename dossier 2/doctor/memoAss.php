...
$date=date("Y-m-d H:i:s",strtotime($d.'+22 hours'));
	$msg=$_POST['msg']; 
	$sql = "insert into memoasses (text,datehr) values ('$msg','$date')";
	$dbh->exec($sql);
}
if (isset($_POST["quiter"])){
	
	
	 header("location:http://localhost/doctor/doctorMemo.php");
  ...
  <div class="login-wrap">
	<div class="login-html">
		...
		<div class="login-form">
            ...
            <form  method="POST" >
				<div class="group">
					<label for="user" class="label">ce message est distiné a l'assistante </label>
