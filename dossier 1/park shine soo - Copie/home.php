...
//error_reporting(0);
  ...
  IF (!empty($err)) {
    ...
    $sql =$con->query("SELECT emailAss,passAss FROM cnxassistants WHERE emailAss='".$email."' and passAss='".$password."' limit 1");
 
	if(($sql)->num_rows==1)
	{
echo "welcome";		
// include("../assistante/index.php");
header('Location: http://localhost/doctor/assistante/index.php');
exit();
  }else{
...
if(isset($_POST['contact_btn']))
  {
    ...
    $passwordd=($_POST['passwordd']);
	 ...
	 IF (empty($emaild) || empty($passwordd)) {
  ...
  IF (!empty($erreur)) {
    ...
    // Fetch data from database on the basis of username/email and password
    $sqli =$con->query("SELECT email,password FROM medecins WHERE email='".$emaild."' and password='".$passwordd."' limit 1");
...
<!-- <script langage="javascript" type="text/javascript"> window.history.forward();</script> -->
</head>
<body>
        ...
        <div class="user_forms-login">
          ...
          <form class="forms_form"  action="#" method="POST">
            ...
            <div class="form-group contact_us">  
			 ...
			 <div class="form-group contact_us">
              <input type="password" name="mdpass" class="full text-center" id="societe" placeholder="  Mot De Passe  "/>
            </div>
          ...
          <form class="forms_form" action="#" method="POST">
            <div class="form-group contact_us">
             <br>  <br>  <br> 
                          ...
                          <div class="form-group contact_us">
                            <input type="email" name="emaild"  class="full text-center" id="email" placeholder="  Email  "/>
						  ...
						  <div class="form-group contact_us">
                          <input type="password" name="passwordd" class="full text-center" id="societe"  placeholder="  Mot De Passe  "/>
                            <!-- <i class="fas fa-building"></i> -->
                          </div>
<div class="form-group contact_us">
             <a href="http://localhost/colorlib-regform-20/loginDoc.php" style="color:blue;">Mot de passe oublié</a>
            </div>    <div class="form-group contact_us">
             <br>   
            </div>
                      

                          <button class="btn btn-warning" type="submit" name="contact_btn"><span>CONNEXION </span></button>
          </form>
        </div>
      </div>
    </div>
