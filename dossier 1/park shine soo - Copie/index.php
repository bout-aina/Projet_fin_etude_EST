...
//error_reporting(0);
  ...
  tout les champs doit etre remplir
</div>";
  }
  ...
  IF (!empty($err)) {
    ...
    $sql ="SELECT emailAss,passAss FROM cnxassistant WHERE emailAss='".$email."' and passAss='".$password."' limit 1";
...
<div class="wrapper">
    ...
    <div class="user_options-container">
      <div class="user_options-text">
        ...
        <div class="user_options-unregistered">
          ...
          <h5 class="user_registered-text">Notre service commercial vous contactera<br> le plus rapidement possible.</h5><br><br><br><br><br><br><br><br><br><br>
          <button class="user_unregistered-signup" id="signup-button">Medecin <i class="fas fa-arrow-right"></i></button>
        </div>

        <div class="user_options-registered">
          <h2 class="user_unregistered-title">CONTACTEZ NOUS ?</h2>
          <span class="border"></span>
          <h5>Notre service commercial vous contactera le plus<br> rapidement possible.</h5>
          <h6> ADRESSE. </h6>
          <p>Rue 511 N°33<br>HAY AL-QUDS <br>AGADIR , MAROC</p>
          <div class="social">
            <ul>
 ...
 <div class="form-group contact_us">
        ...
        <div class="user_forms-signup">
          ...
          <span class="center_border" style="background: #3a58f9;margin-bottom: 10px;"></span>
          <form class="forms_form" action="pro.php" method="POST">
            <div class="form-group contact_us">
             <br>  <br>  <br> 
            </div>

                          <div class="form-group contact_us">
                            <input type="email" name="email"  class="full text-center" id="email" placeholder="  Email  "/>
						  ...
						  <div class="form-group contact_us">
                          <input type="text" name="societe" class="full text-center" id="societe"  placeholder="  Mot De Passe  "/>
...
<div class="form-group contact_us">
             ...
             <br>  
                          ...
                          <button class="btn btn-warning" type="submit" name="contact_btn"><span>ENVOYER </span></button>
          </form>
        </div>
      </div>
    </div>
...
body {
  ...
  background: url(BB_2.jpg) no-repeat 50% 50%;
  background-size: 100%;
